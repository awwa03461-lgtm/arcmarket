  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end bg-black/60" onClick={onClose}>
      ...
      >
        ...
        <h3 className="text-base font-semibold">Create market</h3>

        <div className="mt-4">
          <label className="text-xs text-white/50">Market question</label>
          <textarea
            value={question}
        ...
        <div className="glass mt-4 p-3 text-xs text-white/50">
          ...
          <span className="text-yellow-300/80">
            This market needs an initial subsidy (returned after resolution).
